...
def test_model(test_dir, model_name, n_gram):
    ...
    test_set = feature_extraction.prepare_test_data(dataset=test, order=n_gram)
...
# python test_word_gram_model.py -t test_multidialect_arabic -o 1 -m word_gram_models/multidialect_model_1g
...
if __name__ == '__main__':
    ...
    n = args.order
    test_model(test_dir=test_dir, model_name=model_name, n_gram=n)
